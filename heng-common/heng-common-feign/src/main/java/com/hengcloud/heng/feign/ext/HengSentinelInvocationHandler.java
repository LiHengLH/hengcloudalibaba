...
package com.hengcloud.heng.feign.ext;
 ...
 */
@Slf4j
public class HengSentinelInvocationHandler implements InvocationHandler {
	...
	HengSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			HengSentinelInvocationHandler other = (HengSentinelInvocationHandler) obj;
